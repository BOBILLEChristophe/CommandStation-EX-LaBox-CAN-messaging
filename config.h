...
#define LABOX_MAIN_MOTOR_SHIELD F("LABOXMAIN"), \
 new MotorDriver(12, 13, UNUSED_PIN, 14, 36, 0.10, 2000, UNUSED_PIN)
...
#define WIFI_SSID "ELENABACALAR"
//
// WIFI_PASSWORD is the network password for your home network or if
// you want to change the password from default AP mode password
// to the AP password you want. 
// Your password may not contain ``"'' (double quote, ASCII 0x22).
#define WIFI_PASSWORD "elenabacalar2023"
//
...
/* ----- CAN ----------------------*/
#define CAN
#define CAN_RX GPIO_NUM_22              // Optional, default Rx pin is GPIO_NUM_4
#define CAN_TX GPIO_NUM_23              // Optional, default Tx pin is GPIO_NUM_5
#define CAN_BITRATE 1000L * 1000UL      // 1 Mb/s
